...
@section('title') ویرابش کد تخفیف  @endsection
@section('css')
...
@section('content')
    @component('panel.components.breadcrumb')
        @slot('title') ویرابش کد تخفیف جدید @endslot
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control" name="type" >
                                            ...
                                            @foreach(\App\Models\Coupon::$types as $typeName =>  $type)
                                                <option value="{{ $type }}"
                                                        @if($type == old('type' , $coupon->type)) selected @endif
                                                > {{ $typeName }}
                                                    </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" id="expired_at_input" class="form-control" name="expired_at"
                                               ...
                                               value="{{ old('expired_at' , \Morilog\Jalali\Jalalian::fromDateTime($coupon->expired_at)->format('Y-m-d h:i') ) }}">
