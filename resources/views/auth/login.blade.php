                                ...
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form action="{{ route('login') }}" method="post">
                                            @csrf
                                            <input type="text" name="email" placeholder="ایمیل" autofocus autocomplete="on">
                                            <input type="password" name="password" placeholder="رمز عبور" autocomplete="current-password">
                                            <div class="button-box">
                                                ...
                                                <a href="{{ route('auth.google.redirect') }}" class="btn btn-google btn-block mt-4">
